...
export function computeStructureAwareTradePlan(
  ...
  const stop = buildStop(cleanDirection, avgEntry, atrPct, localLevels, maxStopDistancePct);
  ...
  const [tp1, tp2, tp3, tp4] = targetMeta.targets;
  ...
  return {
    ...
    targetBasis: targetMeta.targetBasis,
