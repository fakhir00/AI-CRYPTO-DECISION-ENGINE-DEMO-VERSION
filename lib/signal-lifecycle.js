...
export function createManagedSignal(options = {}) {
  const preset = SIGNAL_STRATEGY_PRESETS[options.strategyPreset || 'SCALP_15M'] || SIGNAL_STRATEGY_PRESETS.SCALP_15M;
  ...
  const timeInvalidationText = `Cancel if entry not triggered within ${expiryCandles} x ${timeframe} candles`;
